...
class FeedbacksOperationsV1 extends pip_services_facade_node_1.FacadeOperations {
    constructor() {
        super();
        this._dependencyResolver.put('feedbacks', new pip_services_commons_node_1.Descriptor('pip-services-feedbacks', 'client', '*', '*', '1.0'));
    }
