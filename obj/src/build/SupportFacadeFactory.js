...
class SupportFacadeFactory extends pip_services_commons_node_1.Factory {
    constructor() {
        super();
...
SupportFacadeFactory.Descriptor = new pip_services_commons_node_2.Descriptor("pip-facade-support", "factory", "default", "default", "1.0");
SupportFacadeFactory.AnnouncementsOperationsV1Descriptor = new pip_services_commons_node_2.Descriptor("pip-facade-support", "operations", "announcements", "*", "1.0");
SupportFacadeFactory.FeedbacksOperationsV1Descriptor = new pip_services_commons_node_2.Descriptor("pip-facade-support", "operations", "feedbacks", "*", "1.0");
